...
describe("ArticlesTable tests", () => {
    ...
    test("Has the expected column headers and content for adminUser", () => {
        ...
        expect(getByTestId(`${testId}-cell-row-0-col-title`)).toHaveTextContent("Olé Finishes First in Woodstock's Pizza Contest");
        expect(getByTestId(`${testId}-cell-row-1-col-title`)).toHaveTextContent("Olé Steals Triton's Surfboard");
        expect(getByTestId(`${testId}-cell-row-2-col-title`)).toHaveTextContent("Olé Commits Tax Evasion");
